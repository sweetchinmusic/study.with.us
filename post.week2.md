...
1. [프리미티브 타입 종류](#primitive-type-기본형-프리미티브-타입)와 [값의 범위 그리고 기본 값](#값의 범위와 기본 값)
2. [프리미티브 타입과 레퍼런스 타입](#primitive-type-vs-reference-type) 
3. [리터럴](#literal-리터럴)
4. [변수 선언 및 초기화하는 방법](#변수-선언-및-초기화하는-방법)
5. [변수의 스코프와 라이프타임](#변수-스코프와-라이프타임)
6. [타입 변환](#타입변환캐스팅은), 캐스팅 그리고 [타입 프로모션](#타입-프로모션이란)
